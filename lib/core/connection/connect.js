...
const connect = hook.wrapAsync('libCoreConnectionConnect.connect', function connect(
  options,
  callback
) {
...
const makeConnection = hook.wrapAsync(
  'libCoreConnectionConnect.makeConnection',
